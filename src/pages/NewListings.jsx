  ...
  return (
    <div className="min-h-screen bg-[#0A0B0D]">
      ...
      <div className="max-w-4xl mx-auto p-6">
        <h1 className="text-2xl font-bold text-white mb-2">New Listings</h1>
        <p className="text-[#8A919E] mb-6">Most recently added cryptocurrencies</p>
              ...
              <tbody>
                {cryptos.map((crypto) => (
                  <tr key={crypto._id} className="border-t border-[#23262B]">
                    ...
                    <td className="p-4 text-right text-[#8A919E]">{formatDate(crypto.createdAt)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
